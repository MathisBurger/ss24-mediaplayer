...
public class PlayListTest {
    ...
    public void testPlayListIsEmptyAtBeginning() {
        PlayList pl = new PlayList();
        try {
            Assert.assertNull(pl.currentAudioFile());
        } catch (IllegalArgumentException e) {
            Assert.fail("getCurrentAudioFile() yields exception for empty PlayList");
        }
    }
    ...
    public void testNextSongOnEmptyPlayList() {
        ...
        try {
            ...
            Assert.fail("currentAudioFile() yields exception for empty PlayList");
        }
    }
    ...
    public void testSaveAndLoadM3U() {
        ...
        Assert.assertTrue("Unable to create M3U file", m3u.exists());
        ...
        try {
            ...
            Assert.fail("Unable to append to M3U file:" + e.toString());
        }
        pl1 = null;
    ...
    public void testExceptionDueToNonExistentM3UFile() {
        try {
            ...
            Assert.fail("Expected exception not thrown for non-existing PlayList file!");
        } catch (Exception e) {
            // Expected
        }
    }
    ...
    public void testSearchAndSortDoesNotChangeOrder() {
        ...
        Assert.assertTrue("Iterator should provide one more result", tmp.hasNext());
        ...
        Assert.assertFalse("Should only provide two elements", iterator.hasNext());
    }
