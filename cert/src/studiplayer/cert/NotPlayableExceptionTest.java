...
public class NotPlayableExceptionTest {
    ...
    public void testConstructors() {
        try {
            ...
            Assert.assertTrue("toString von NotPlayableException ungenuegend", ts.contains("abc-path")
    ...
    public void testDeclarations() {
        ...
        try {
            ...
            Assert.fail("Geforderte Methode existiert nicht " + e);
        }
    }
}
